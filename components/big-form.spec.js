...
import ComponentUnderTest from "./big-form.js";
const isolated = { test, useIframe: true };
test("big-form should render", ({ diff, id, container, name }) => {
    const result = jsx(ComponentUnderTest, null);
...
isolated.test("big-form should render again", ({ diff, id, container, name, fail }) => {
    const result = jsx(ComponentUnderTest, null);
    diff(result, [JsxSymbol, "div", null, []]);
